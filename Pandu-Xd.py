...
class Menu:
	...
	def menu(self):
		...
		###----------[ PANEL BIASA ]---------- ###
		prints(Panel(f"{P2}IP ADDRESS{self.ip}",padding=(0,30),title=f"{H2}NAMA FACEBOOK{nama}",subtitle=f"{H2} COUNTRY{self.negara}",style=f"{color_panel}"))
