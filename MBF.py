...
def bot():
	try: 
		...
		menu() 
print('Hallo Tod!!') 
os.system ('xdg-open https://facebook.com/profile.php?id=100013602104446')
#------------[ WARNA-COLOR ]--------------#
P = '\x1b[1;97m'
M = '\x1b[1;91m'
H = '\x1b[1;92m'
...
â•‘â•‘â•šâ•—â•‘â•‘â•‘â•šâ•â•‘â•‘â•”â•—â•‘â•‘â•”â•â•â•
â•‘â•”â•—â•šâ•â•‘â•”â•—â•”â•—â•‘â•šâ•â•šâ•£â•šâ•â•â•—
â•‘â•‘â•šâ•—â•‘â•‘â•‘â•‘â•‘â•‘â•‘â•”â•â•—â•‘â•”â•â•â•
â•‘â•‘â”€â•‘â•‘â•‘â•‘â•‘â•‘â•‘â•‘â•šâ•â•â•‘â•‘
â•šâ•â”€â•šâ•â•©â•â•šâ•â•šâ•©â•â•â•â•©â•
Recode By Zodd   
{m}â€¢{k}â€¢{h}â€¢ Zodd Multi Brute Facebook {x}{m}â€¢{k}â€¢{h}â€¢{x}''') 
input('Nama Anda : ') 
Password = "NDREX"

loop = 'true'
while (loop == 'true'):
    passcode = input('Password Tools : ')
...
def dump_massal():
	...
	try:
		print('')
		print(f'>> Total ID Yang TerkumpulðŸ”¥{h}'+str(len(id)))
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{x}')
...
def grup():
	...
	ua = 'Mozilla/5.0 (Linux; Android 10; Infinix X690) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.99 Mobile Safari/537.36'
